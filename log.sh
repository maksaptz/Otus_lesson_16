...
echo '$AllowedSender UDP, 192.168.50.11/24, [::1]/128
$AllowedSender TCP, 192.168.50.11/24, [::1]/128' >> /etc/rsyslog.conf
###Настраиваем шаблон
echo '$template RemInputLogs, "/var/spool/rsyslog/%FROMHOST-IP%/%PROGRAMNAME%.log"
